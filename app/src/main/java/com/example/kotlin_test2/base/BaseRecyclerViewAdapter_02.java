...
public abstract class BaseRecyclerViewAdapter_02<T, VDB extends ViewDataBinding> extends RecyclerView.Adapter<BindingViewHolder<VDB>> {
    ...
    public BaseRecyclerViewAdapter_02(Context context) {
    ...
    public BindingViewHolder<VDB> onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ViewDataBinding binding = DataBindingUtil.inflate(layoutInflater, getRecyclerViewItemID(viewType), parent, false);
